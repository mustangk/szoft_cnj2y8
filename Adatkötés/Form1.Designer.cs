namespace Adatkötés
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Size = new Size(429, 456);
            ...
            // buttonDelete
            // 
            buttonDelete.Location = new Point(459, 17);
            ...
            // buttonHozzáadás
            // 
            buttonHozzáadás.Location = new Point(558, 17);
            buttonHozzáadás.Name = "buttonHozzáadás";
            buttonHozzáadás.Size = new Size(75, 23);
            buttonHozzáadás.TabIndex = 2;
            buttonHozzáadás.Text = "Hozzáadás";
            buttonHozzáadás.UseVisualStyleBackColor = true;
            buttonHozzáadás.Click += buttonHozzáadás_Click;
            // 
            // textBox1
            // 
            textBox1.DataBindings.Add(new Binding("Text", countryDataBindingSource, "Name", true));
            textBox1.Location = new Point(456, 93);
            ...
            textBox3.Location = new Point(456, 180);
